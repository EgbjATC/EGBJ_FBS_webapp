...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1315: (x0,x1) => x0.createElement(x1),
      _1322: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1330: x0 => ({scale: x0}),
      _1331: (x0,x1) => x0.getItem(x1),
      _1332: (x0,x1) => x0.removeItem(x1),
      ...
      _1365: s => JSON.stringify(s),
      _1366: s => printToConsole(s),
      _1367: o => {
        if (o === null || o === undefined) return 0;
        if (typeof(o) === 'string') return 1;
        return 2;
      },
      _1368: (o, p, r) => o.replaceAll(p, () => r),
      _1369: (o, p, r) => o.replace(p, () => r),
      _1370: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1371: s => s.toUpperCase(),
      _1372: s => s.trim(),
      _1373: s => s.trimLeft(),
      _1374: s => s.trimRight(),
      _1375: (string, times) => string.repeat(times),
      _1376: Function.prototype.call.bind(String.prototype.indexOf),
      _1377: (s, p, i) => s.lastIndexOf(p, i),
      _1378: (string, token) => string.split(token),
      _1379: Object.is,
      ...
      _1488: x0 => x0.random(),
      _1489: (x0,x1) => x0.getRandomValues(x1),
      _1490: () => globalThis.crypto,
      ...
      _1538: o => o.length,
      _1540: (o, i) => o[i],
      _1541: f => f.dartFunction,
      _1542: () => ({}),
      _1543: () => [],
      _1545: () => globalThis,
      _1546: (constructor, args) => {
      ...
      _1548: (o, p) => o[p],
      _1549: (o, p, v) => o[p] = v,
      _1550: (o, m, a) => o[m].apply(o, a),
      _1552: o => String(o),
      _1553: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1554: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1554(f,arguments.length,x0) }),
      _1555: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1555(f,arguments.length,x0,x1) }),
      _1556: o => {
      ...
      _1583: (o, p) => p in o,
      _1584: (o, p) => o[p],
      _1587: (x0,x1,x2) => x0.transaction(x1,x2),
      _1588: (x0,x1) => x0.objectStore(x1),
      _1589: (x0,x1) => x0.getAllKeys(x1),
      _1590: (x0,x1) => x0.getAll(x1),
      _1591: (x0,x1) => x0.get(x1),
      _1592: (x0,x1) => x0.delete(x1),
      _1593: (x0,x1,x2) => x0.put(x1,x2),
      _1595: x0 => x0.close(),
      _1597: (x0,x1,x2) => x0.open(x1,x2),
      _1598: (x0,x1) => x0.contains(x1),
      _1601: (x0,x1) => x0.createObjectStore(x1),
      ...
      _1619: (x0,x1,x2) => ({name: x0,counter: x1,length: x2}),
      _1632: (x0,x1) => ({name: x0,hash: x1}),
      _1634: () => new XMLHttpRequest(),
      _1637: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1648: (x0,x1) => new WebSocket(x0,x1),
      _1649: (x0,x1) => x0.send(x1),
      _1650: (x0,x1,x2) => x0.close(x1,x2),
      _1651: (x0,x1) => x0.close(x1),
      _1652: x0 => x0.close(),
      _1653: (x0,x1,x2) => x0.open(x1,x2),
      _1654: x0 => x0.abort(),
      _1655: x0 => x0.getAllResponseHeaders(),
      _1659: x0 => new BroadcastChannel(x0),
      _1660: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1660(f,arguments.length,x0) }),
      _1661: (x0,x1) => x0.postMessage(x1),
      _1662: x0 => x0.close(),
      ...
      _1667: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1667(f,arguments.length,x0,x1,x2) }),
      _1668: (x0,x1) => x0.forEach(x1),
      _1669: x0 => x0.getReader(),
      _1670: x0 => x0.cancel(),
      _1671: x0 => x0.read(),
      _1672: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1672(f,arguments.length,x0) }),
      _1673: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1673(f,arguments.length,x0) }),
      _1674: x0 => x0.openCursor(),
      _1675: x0 => x0.continue(),
      _1676: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1676(f,arguments.length,x0) }),
      _1677: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1677(f,arguments.length,x0) }),
      _1678: (x0,x1,x2,x3) => ({method: x0,headers: x1,body: x2,credentials: x3}),
      _1679: (x0,x1,x2) => x0.fetch(x1,x2),
      ...
      _1735: (a, i) => a.push(i),
      _1736: (t, s) => t.set(s),
      _1737: l => new DataView(new ArrayBuffer(l)),
      ...
      _1781: () => globalThis.window.isSecureContext,
      _1782: () => globalThis.crypto.subtle,
      _1783: (x0,x1,x2) => globalThis.crypto.subtle.decrypt(x0,x1,x2),
      _1790: (x0,x1,x2,x3,x4) => globalThis.crypto.subtle.importKey(x0,x1,x2,x3,x4),
      _1791: (x0,x1,x2) => globalThis.crypto.subtle.sign(x0,x1,x2),
      _1840: () => globalThis.console,
      _1879: (x0,x1) => x0.error(x1),
      _1929: x0 => x0.readyState,
      _1931: (x0,x1) => { x0.timeout = x1 },
      _1933: (x0,x1) => { x0.withCredentials = x1 },
      _1934: x0 => x0.upload,
      _1935: x0 => x0.responseURL,
      _1936: x0 => x0.status,
      _1937: x0 => x0.statusText,
      ...
      _3717: () => globalThis.window,
      _3755: x0 => x0.self,
      _3759: x0 => x0.location,
      _3778: x0 => x0.navigator,
      _4035: x0 => x0.indexedDB,
      _4042: x0 => x0.localStorage,
      _4050: x0 => x0.href,
      _4167: x0 => x0.userAgent,
      _4218: x0 => x0.data,
      _4265: (x0,x1) => { x0.onmessage = x1 },
      _4372: x0 => x0.length,
      _4589: x0 => x0.readyState,
      _4602: (x0,x1) => { x0.binaryType = x1 },
      _4605: x0 => x0.code,
      _4606: x0 => x0.reason,
      _6274: x0 => x0.target,
      _6314: x0 => x0.signal,
      ...
      _6803: x0 => x0.id,
      _6804: (x0,x1) => { x0.id = x1 },
      _8150: x0 => x0.value,
      _8152: x0 => x0.done,
      _8853: x0 => x0.url,
      _8855: x0 => x0.status,
      _8857: x0 => x0.statusText,
      _8858: x0 => x0.headers,
      _8859: x0 => x0.body,
      _10315: x0 => x0.result,
      _10316: x0 => x0.error,
      _10321: (x0,x1) => { x0.onsuccess = x1 },
      _10323: (x0,x1) => { x0.onerror = x1 },
      _10327: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10345: x0 => x0.version,
      _10346: x0 => x0.objectStoreNames,
      _10413: x0 => x0.key,
      _10416: x0 => x0.value,
      _10976: (x0,x1) => { x0.border = x1 },
      _11418: (x0,x1) => { x0.height = x1 },
      _12108: (x0,x1) => { x0.width = x1 },
      _12476: x0 => x0.name,
